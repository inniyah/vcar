...
const uint32 mask_11  = 0x000007FFUL;
								 /* Priority */
const uint32 mask_pri = 0x1C000000UL;
								 /* Parameter Group Number */
const uint32 mask_pgn = 0x03FFFF00UL;
								 /* Reserved */
const uint32 mask_res = 0x02000000UL;
								 /* Data Page */
const uint32 mask_dp  = 0x01000000UL;
								 /* PDU Format */
const uint32 mask_pf  = 0x00FF0000UL;
								 /* PDU Specific */
const uint32 mask_ps  = 0x0000FF00UL;
								 /* Source Address */
const uint32 mask_sad = 0x000000FFUL;

...
extern Fl_Group *wExportButtons;
#include <FL/Fl_Button.H>
extern Fl_Button *wToPngButton;
extern Fl_Button *wToSvgButton;
extern Fl_Button *wToEpsButton;
extern Fl_Button *wToPdfButton;
extern Fl_Button *wToScriptButton;
